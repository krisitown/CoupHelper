    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPlayerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final int currentId = editText.generateViewId();
                final LinearLayout nameAndCross = new LinearLayout(context);
                nameAndCross.setLayoutParams(new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.WRAP_CONTENT,
                        LinearLayout.HORIZONTAL));
                nameAndCross.setGravity(Gravity.CENTER);
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        layout.removeView(nameAndCross);
                        playerNames.remove(editText);
                    }
                });


                nameAndCross.addView(editText);
                nameAndCross.addView(button);

                layout.addView(nameAndCross);
